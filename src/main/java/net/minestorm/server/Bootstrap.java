...
import net.minestorm.server.extras.selfmodification.mixins.MixinCodeModifier;
import net.minestorm.server.extras.selfmodification.mixins.MixinServiceMinestom;
...
public final class Bootstrap {
    ...
    public static void bootstrap(String mainClassFullName, String[] args) {
        try {
            ...
            Class<?> serverClass = classLoader.loadClass("net.minestorm.server.MinecraftServer");
