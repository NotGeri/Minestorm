package net.minestorm.codegen.fluid;
...
public final class FluidGenerator extends MinestormCodeGenerator {
    ...
    public void generate() {
        ...
        ClassName registriesClassName = ClassName.get("net.Minestorm.server.registry", "Registries");

        JsonObject fluids = GSON.fromJson(new InputStreamReader(fluidsFile), JsonObject.class);
        ClassName fluidClassName = ClassName.get("net.Minestorm.server.fluid", "Fluid");
        ...
        writeFiles(
                Collections.singletonList(
                        JavaFile.builder("net.Minestorm.server.fluid", fluidClass.build())
                                .indent("    ")
