package net.minestorm.demo.largeframebuffers;
...
import net.minestorm.server.entity.metadata.other.ItemFrameMeta;
...
import net.minestorm.server.item.metadata.MapMeta;
import net.minestorm.server.map.Framebuffer;
import net.minestorm.server.map.LargeFramebuffer;
import net.minestorm.server.map.MapColors;
import net.minestorm.server.map.framebuffers.LargeDirectFramebuffer;
import net.minestorm.server.map.framebuffers.LargeGLFWFramebuffer;
import net.minestorm.server.map.framebuffers.LargeGraphics2DFramebuffer;
import net.minestorm.server.map.framebuffers.MapColorRenderer;
import net.minestorm.server.network.packet.server.play.MapDataPacket;
