...
public final class VillagerTypeGenerator extends MinestormCodeGenerator {
    ...
    public void generate() {
        ...
        ClassName villagerTypeClassName = ClassName.get("net.minestorm.server.entity.metadata.villager", "VillagerType");
        ...
        writeFiles(
                Collections.singletonList(
                        JavaFile.builder("net.minestorm.server.entity.metadata.villager", villagerTypeClass.build())
                                .indent("    ")
