package net.minestorm.server;

import net.minestorm.server.advancements.AdvancementManager;
import net.minestorm.server.adventure.bossbar.BossBarManager;
import net.minestorm.server.command.CommandManager;
import net.minestorm.server.data.DataManager;
...
import net.minestorm.server.exception.ExceptionManager;
import net.minestorm.server.extensions.Extension;
import net.minestorm.server.extensions.ExtensionManager;
import net.minestorm.server.fluid.Fluid;
import net.minestorm.server.gamedata.tags.TagManager;
...
import net.minestorm.server.instance.block.rule.BlockPlacementRule;
...
import net.minestorm.server.network.PacketProcessor;
import net.minestorm.server.network.packet.server.play.PluginMessagePacket;
import net.minestorm.server.network.packet.server.play.ServerDifficultyPacket;
import net.minestorm.server.network.packet.server.play.UpdateViewDistancePacket;
import net.minestorm.server.network.socket.Server;
import net.minestorm.server.ping.ResponseDataConsumer;
import net.minestorm.server.recipe.RecipeManager;
import net.minestorm.server.scoreboard.TeamManager;
import net.minestorm.server.storage.StorageLocation;
import net.minestorm.server.storage.StorageManager;
import net.minestorm.server.terminal.MinestomTerminal;
import net.minestorm.server.thread.MinestomThreadPool;
import net.minestorm.server.timer.SchedulerManager;
import net.minestorm.server.utils.MathUtils;
import net.minestorm.server.utils.PacketUtils;
import net.minestorm.server.utils.validate.Check;
import net.minestorm.server.world.Difficulty;
import net.minestorm.server.world.DimensionTypeManager;
...
public final class MinecraftServer {
    ...
    /**
     * Gets the manager handling {@link BlockHandler block handlers}
     ...
     * @deprecated use {@link #start(String, int)} and listen to the {@link ServerListPingEvent} event instead of ResponseDataConsumer
     */
    @Deprecated
