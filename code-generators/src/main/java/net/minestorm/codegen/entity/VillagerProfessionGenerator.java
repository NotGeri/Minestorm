package net.minestorm.codegen.entity;

import com.google.gson.JsonArray;
import com.google.gson.JsonElement;
import com.google.gson.JsonObject;
import com.squareup.javapoet.*;
import net.minestorm.codegen.MinestormCodeGenerator;
...
public final class VillagerProfessionGenerator extends MinestormCodeGenerator {
    ...
    public void generate() {
        ...
        ClassName namespaceIDClassName = ClassName.get("net.Minestorm.server.utils", "NamespaceID");
        ClassName rawVillagerProfessionDataClassName = ClassName.get("net.Minestorm.server.raw_data", "RawVillagerProfessionData");
        ClassName registryClassName = ClassName.get("net.Minestorm.server.registry", "Registry");

        JsonArray villagerProfessions = GSON.fromJson(new InputStreamReader(villagerProfessionsFile), JsonArray.class);
        ClassName villagerProfessionClassName = ClassName.get("net.Minestorm.server.entity.metadata.villager", "VillagerProfession");
        ...
        writeFiles(
                Collections.singletonList(
                        JavaFile.builder("net.Minestorm.server.entity.metadata.villager", villagerProfessionClass.build())
                                .indent("    ")
