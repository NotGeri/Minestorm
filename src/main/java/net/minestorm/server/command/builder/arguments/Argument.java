...
import net.minestorm.server.command.builder.ArgumentCallback;
import net.minestorm.server.command.builder.Command;
import net.minestorm.server.command.builder.CommandExecutor;
...
public abstract class Argument<T> {
     ...
     * and used to retrieve the data when the command is parsed in {@link CommandContext}.
     *
