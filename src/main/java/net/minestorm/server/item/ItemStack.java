...
import net.minestorm.server.item.rule.VanillaStackingRule;
import net.minestorm.server.tag.Tag;
import net.minestorm.server.tag.TagReadable;
import net.minestorm.server.utils.NBTUtils;
...
/**
 * Represents an immutable item to be placed inside {@link PlayerInventory},
 * {@link Inventory} or even on the ground {@link ItemEntity}.
 * <p>
