...
import net.minestorm.server.command.builder.arguments.number.ArgumentDouble;
import net.minestorm.server.command.builder.arguments.number.ArgumentFloat;
import net.minestorm.server.command.builder.arguments.number.ArgumentInteger;
import net.minestorm.server.command.builder.arguments.number.ArgumentLong;
import net.minestorm.server.command.builder.arguments.relative.ArgumentRelativeBlockPosition;
import net.minestorm.server.command.builder.arguments.relative.ArgumentRelativeVec2;
import net.minestorm.server.command.builder.arguments.relative.ArgumentRelativeVec3;
import net.minestorm.server.command.builder.parser.ArgumentParser;
import net.minestorm.server.command.builder.arguments.minecraft.*;
import net.minestorm.server.command.builder.arguments.minecraft.registry.ArgumentEnchantment;
import net.minestorm.server.command.builder.arguments.minecraft.registry.ArgumentEntityType;
import net.minestorm.server.command.builder.arguments.minecraft.registry.ArgumentParticle;
