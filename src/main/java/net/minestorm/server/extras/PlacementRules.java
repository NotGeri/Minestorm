package net.minestorm.server.extras;
...
import net.minestorm.server.instance.block.rule.vanilla.AxisPlacementRule;
import net.minestorm.server.instance.block.rule.vanilla.RedstonePlacementRule;
import net.minestorm.server.instance.block.rule.vanilla.WallPlacementRule;
