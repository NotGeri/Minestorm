package net.minestorm.server.extensions;
...
import net.minestorm.server.extras.selfmodification.MinestomExtensionClassLoader;
...
public class ExtensionManager {
     ...
     *
     * @return true if extensions are loaded in {@link MinecraftServer#start(String, int, ResponseDataConsumer)}
     */
