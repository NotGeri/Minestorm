package net.minestorm.server.extras.query;
...
import net.minestorm.server.extras.query.event.BasicQueryEvent;
import net.minestorm.server.extras.query.event.FullQueryEvent;
import net.minestorm.server.timer.Task;
import net.minestorm.server.utils.NetworkUtils;
