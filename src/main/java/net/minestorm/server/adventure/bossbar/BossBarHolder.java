package net.minestorm.server.adventure.bossbar;
...
import net.minestorm.server.network.packet.server.play.BossBarPacket;
...
import static net.minestorm.server.network.packet.server.play.BossBarPacket.Action.*;
