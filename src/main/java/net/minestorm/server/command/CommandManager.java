...
import net.minestorm.server.command.builder.*;
import net.minestorm.server.command.builder.arguments.Argument;
import net.minestorm.server.command.builder.arguments.minecraft.SuggestionType;
import net.minestorm.server.command.builder.condition.CommandCondition;
import net.minestorm.server.command.builder.parser.ArgumentQueryResult;
import net.minestorm.server.command.builder.parser.CommandParser;
import net.minestorm.server.command.builder.parser.CommandQueryResult;
import net.minestorm.server.entity.Player;
import net.minestorm.server.event.EventDispatcher;
import net.minestorm.server.event.player.PlayerCommandEvent;
import net.minestorm.server.network.packet.server.play.DeclareCommandsPacket;
import net.minestorm.server.utils.ArrayUtils;
import net.minestorm.server.utils.callback.CommandCallback;
