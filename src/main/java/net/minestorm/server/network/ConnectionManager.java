...
import net.minestorm.server.event.player.AsyncPlayerPreLoginEvent;
import net.minestorm.server.event.player.PlayerLoginEvent;
import net.minestorm.server.instance.Instance;
import net.minestorm.server.listener.manager.ClientPacketConsumer;
import net.minestorm.server.listener.manager.ServerPacketConsumer;
import net.minestorm.server.network.packet.client.login.LoginStartPacket;
import net.minestorm.server.network.packet.server.login.LoginSuccessPacket;
import net.minestorm.server.network.packet.server.play.DisconnectPacket;
import net.minestorm.server.network.packet.server.play.KeepAlivePacket;
...
public final class ConnectionManager {
     ...
     * @deprecated see {@link PlayerPacketEvent}
     */
    @NotNull
    @Deprecated
     ...
     * @deprecated listen to {@link PlayerPacketEvent}
     */
    @Deprecated
