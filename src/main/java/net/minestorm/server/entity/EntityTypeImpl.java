...
import net.minestorm.server.entity.metadata.PlayerMeta;
import net.minestorm.server.entity.metadata.ambient.BatMeta;
import net.minestom.server.entity.metadata.animal.*;
import net.minestorm.server.entity.metadata.animal.tameable.CatMeta;
import net.minestorm.server.entity.metadata.animal.tameable.ParrotMeta;
import net.minestorm.server.entity.metadata.animal.tameable.WolfMeta;
import net.minestorm.server.entity.metadata.arrow.ArrowMeta;
import net.minestorm.server.entity.metadata.arrow.SpectralArrowMeta;
import net.minestorm.server.entity.metadata.arrow.ThrownTridentMeta;
import net.minestorm.server.entity.metadata.flying.GhastMeta;
import net.minestorm.server.entity.metadata.flying.PhantomMeta;
import net.minestorm.server.entity.metadata.golem.IronGolemMeta;
import net.minestorm.server.entity.metadata.golem.ShulkerMeta;
import net.minestorm.server.entity.metadata.golem.SnowGolemMeta;
...
import net.minestorm.server.entity.metadata.monster.skeleton.SkeletonMeta;
import net.minestorm.server.entity.metadata.monster.skeleton.StrayMeta;
import net.minestorm.server.entity.metadata.monster.skeleton.WitherSkeletonMeta;
import net.minestorm.server.entity.metadata.monster.zombie.DrownedMeta;
import net.minestorm.server.entity.metadata.monster.zombie.HuskMeta;
import net.minestorm.server.entity.metadata.monster.zombie.ZombieMeta;
import net.minestorm.server.entity.metadata.monster.zombie.ZombieVillagerMeta;
import net.minestorm.server.entity.metadata.monster.zombie.ZombifiedPiglinMeta;
import net.minestom.server.entity.metadata.other.*;
import net.minestorm.server.entity.metadata.villager.VillagerMeta;
import net.minestorm.server.entity.metadata.villager.WanderingTraderMeta;
import net.minestorm.server.entity.metadata.water.AxolotlMeta;
import net.minestorm.server.entity.metadata.water.DolphinMeta;
import net.minestorm.server.entity.metadata.water.GlowSquidMeta;
import net.minestorm.server.entity.metadata.water.SquidMeta;
import net.minestorm.server.entity.metadata.water.fish.CodMeta;
import net.minestorm.server.entity.metadata.water.fish.PufferfishMeta;
import net.minestorm.server.entity.metadata.water.fish.SalmonMeta;
import net.minestorm.server.entity.metadata.water.fish.TropicalFishMeta;
import net.minestorm.server.registry.Registry;
import net.minestorm.server.entity.metadata.animal.*;
import net.minestorm.server.entity.metadata.item.*;
import net.minestorm.server.entity.metadata.minecart.*;
import net.minestorm.server.entity.metadata.monster.*;
import net.minestorm.server.entity.metadata.monster.raider.*;
import net.minestorm.server.entity.metadata.other.*;
