...
import net.minestorm.server.adventure.MinestomAdventure;
...
import net.minestorm.server.network.packet.FramedPacket;
import net.minestorm.server.network.packet.server.ComponentHoldingServerPacket;
import net.minestorm.server.network.packet.server.ServerPacket;
import net.minestorm.server.network.packet.server.login.SetCompressionPacket;
import net.minestorm.server.network.socket.Worker;
import net.minestorm.server.utils.PacketUtils;
import net.minestorm.server.utils.Utils;
import net.minestorm.server.utils.binary.BinaryBuffer;
import net.minestorm.server.utils.binary.PooledBuffers;
import net.minestorm.server.utils.validate.Check;
import net.minestorm.server.network.packet.client.handshake.HandshakePacket;
...
public class PlayerSocketConnection extends PlayerConnection {
     ...
     * <p>
     * All packets are flushed during {@link Player#update(long)}.
     *
