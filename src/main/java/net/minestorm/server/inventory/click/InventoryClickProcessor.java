package net.minestorm.server.inventory.click;

import net.minestorm.server.entity.EquipmentSlot;
import net.minestorm.server.entity.Player;
import net.minestorm.server.event.EventDispatcher;
import net.minestorm.server.event.inventory.InventoryClickEvent;
import net.minestorm.server.event.inventory.InventoryPreClickEvent;
...
import net.minestorm.server.inventory.TransactionType;
import net.minestorm.server.inventory.condition.InventoryCondition;
import net.minestorm.server.inventory.condition.InventoryConditionResult;
import net.minestorm.server.item.ItemStack;
import net.minestorm.server.item.Material;
import net.minestorm.server.item.StackingRule;
